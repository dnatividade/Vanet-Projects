...
const char *BorderMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool BorderMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    BorderMsg *pp = (BorderMsg *)object; (void)pp;
    switch (field) {
        case FIELD_policy: pp->setPolicy(string2long(value)); return true;
...
void *BorderMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    BorderMsg *pp = (BorderMsg *)object; (void)pp;
    switch (field) {
        case FIELD_startPos: return toVoidPtr(&pp->getStartPos()); break;
