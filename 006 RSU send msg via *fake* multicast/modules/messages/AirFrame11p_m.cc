//
// Generated file, do not edit! Created by nedtool 5.7 from veins/modules/messages/AirFrame11p.msg.
//
...
bool AirFrame11pDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    AirFrame11p *pp = (AirFrame11p *)object; (void)pp;
    switch (field) {
        case FIELD_underMinPowerLevel: pp->setUnderMinPowerLevel(string2bool(value)); return true;
        case FIELD_wasTransmitting: pp->setWasTransmitting(string2bool(value)); return true;
