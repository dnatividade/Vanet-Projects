//
// Generated file, do not edit! Created by nedtool 5.7 from veins/modules/messages/PhyControlMessage.msg.
//
...
bool PhyControlMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_txPower_mW: pp->setTxPower_mW(string2double(value)); return true;
