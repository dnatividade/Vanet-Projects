...
void TraCIDemoRSU11p::initialize(int stage)
{
    ...
    if (stage == 0) {
        ...
        //nodes to delivery the message: node[0], id=16 / node[7], id=58; node[17], id=118; node[23], id=154; node[32], id=208
        std::string multicastAddr;
        multicastAddr = "16;58;118;154;208";

        wsm->setMulticastAddr(multicastAddr.c_str());
