//
// Generated file, do not edit! Created by nedtool 5.7 from veins/modules/application/traci/TraCIDemo11pMessage.msg.
//
...
const char * TraCIDemo11pMessage::getMulticastAddr() const
{
    return this->multicastAddr.c_str();
}

void TraCIDemo11pMessage::setMulticastAddr(const char * multicastAddr)
{
...
unsigned int TraCIDemo11pMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_multicastAddr
    };
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'm' && strcmp(fieldName, "multicastAddr") == 0) return base+3;
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_multicastAddr: return oppstring2string(pp->getMulticastAddr());
        default: return "";
    }
}
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_multicastAddr: pp->setMulticastAddr((value)); return true;
