...
bool Mac80211PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Mac80211Pkt *pp = (Mac80211Pkt *)object; (void)pp;
    switch (field) {
        case FIELD_address3: pp->setAddress3(string2long(value)); return true;
        case FIELD_address4: pp->setAddress4(string2long(value)); return true;
        case FIELD_fragmentation: pp->setFragmentation(string2long(value)); return true;
        case FIELD_informationDS: pp->setInformationDS(string2long(value)); return true;
        case FIELD_sequenceControl: pp->setSequenceControl(string2long(value)); return true;
