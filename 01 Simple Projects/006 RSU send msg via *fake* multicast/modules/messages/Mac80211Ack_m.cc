//
// Generated file, do not edit! Created by nedtool 5.7 from veins/modules/messages/Mac80211Ack.msg.
//
...
bool Mac80211AckDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Mac80211Ack *pp = (Mac80211Ack *)object; (void)pp;
    switch (field) {
        case FIELD_messageId: pp->setMessageId(string2ulong(value)); return true;
