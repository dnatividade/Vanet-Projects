...
void TraCIDemoRSU11p::onWSM(BaseFrame1609_4* frame)
{
    ...
    if (strcmp(wsm->getDemoData(), "ack") == 0) {
        ...
        findHost()->getDisplayString().updateWith("r=30,yellow"); //if message was received and readable, car circle radius = 30; color = yellow
        std::cout << "RSU | received a msg from car: " << wsm->getSenderAddress() << " | SimTime: " << simTime() << endl; //print information
        ...
        std::cout << "RSU | ack sent to car:    " << ack->getRecipientAddress() << " | SimTime: " << simTime() << endl; //print information


        //replay the message to vehicle
        populateWSM(wsm, wsm->getDst(), 2); //send back message to car - link layer ID get from wsm message ********
        ...
        std::cout << "RSU | reply the msg to car:    " << wsm->getRecipientAddress() << " | SimTime: " << simTime() << endl; //print information
...
void TraCIDemoRSU11p::handleSelfMsg(cMessage* msg)
{
    if (TraCIDemo11pMessage* wsm = dynamic_cast<TraCIDemo11pMessage*>(msg)) {
        ...
        if (msgReceived == 0) {
            ...
            std::cout << "RSU | message sent to vehicle: " << wsm->getRecipientAddress() << " | SimTime: " << simTime() << endl; //print information
        }
